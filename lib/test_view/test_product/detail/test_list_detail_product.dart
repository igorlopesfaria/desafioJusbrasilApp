...
class ProductDetailTest extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ProductDetail(getProductModel());
  }
